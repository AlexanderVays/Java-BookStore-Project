...
/**
 * Extract the program options from the commandline arguments and store them for
 * safekeeping.
 * 
 * @author Alexander Vays
 *
 */
public class BookOptions {
	...
	/**
	 * customers Print the customer report books Print the books report purchases
	 * Print the purchases report total When combined with the 'purchases' option,
	 * also print the total value of the purchases by_lastname Sorts the purchases
	 * report by part description in ascending order. This option is ignored if �
	 * purchases is also specified by_title Sorts the purchases report by book title
	 * in ascending order. This option is ignored if purchases is also specified
	 * by_join_date Sorts the customer report by join date in ascending order. This
	 * option is ignored if customers is also specified Any sorted report is sorted
	 * in descending order. Must be combined with 'by_lastname', 'by_title', or
	 * 'by_join_date' customer_id=<id> Filters the purchases report, showing only
	 * customers that match the customer id
	 */
	...
	public enum Value {
		...
		TOTAL("t", "total", false,
				"When combined with the 'purchases' option, also print the total value of the purchases"), //
		...
		BY_JOIN_DATE("J", "by_join_date", false,
				"Sorts the customers report by join date in ascending order. This option is ignored if customers is also specified"), //
		CUSTOMER_ID("C", "customer_id", true,
				"Filters the purchases report, showing only customers that match the customer id"), //
