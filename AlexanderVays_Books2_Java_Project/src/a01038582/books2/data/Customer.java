...
public class Customer {
	 ...
	 *            the local date
	 */
	public void setJoinedDate(LocalDate date) {
	...
	/**
	 * @return JoinedDate in the format of month-day-year
	 */
	public String getJoinedDateString() {
		...
		// MS SQL Server dates are in the format of month-day-year
		String result = joinedDate.format(DateTimeFormatter.ofPattern("MM-dd-yyyy"));
	 ...
	 *            the date to set
	 */
	public void setJoinedDate(java.sql.Date date) {
		joinedDate = date.toLocalDate();
	}
