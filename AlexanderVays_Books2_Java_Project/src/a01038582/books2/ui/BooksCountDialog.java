...
public class BooksCountDialog extends JDialog {
	 ...
	 */
	public BooksCountDialog() throws SQLException {
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setVisible(true);
		setBounds(100, 100, 359, 151);
		setLocationRelativeTo(null);
		setTitle("Books Count");
		...
		{
			JLabel lblNewLabel = new JLabel("Total Books Count");
		...
		}
		{
			...
			try {
				textField.setText(Integer.toString(BookDao.getNumberOfBooks()));
			} catch (Exception e) {
